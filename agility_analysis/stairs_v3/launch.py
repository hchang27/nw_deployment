...
machines = [
    dict(ip="isola-v100-1.csail.mit.edu", gpu_id=3),
    dict(ip="isola-v100-1.csail.mit.edu", gpu_id=4),
    dict(ip="isola-v100-1.csail.mit.edu", gpu_id=5),
]
