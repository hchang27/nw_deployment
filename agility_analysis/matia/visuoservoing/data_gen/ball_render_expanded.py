...
PORT = 8013
app = Vuer(port=PORT, uri=f"ws://localhost:{PORT}", queries={"background": "000000", "grid": False})
...
if __name__ == '__main__':
    ...
    async def show_heatmap(proxy):
        ...
        render_img_size = (512, 512)
        vertical_scale = 512 / 240
        horizontal_scale = 512 / 320

        vertical_fov = get_expanded_fov(vertical_scale, 42.5)
        print("The new vertical fov is", vertical_fov)
