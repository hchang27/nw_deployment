...
class BallXY(PrefixProto, cli=False):
    data_path = Proto(
...
if __name__ == "__main__":
    ...
    dataset = BallXY(transform=transform, device="cuda", debug=True)

    i = 1
    for im, t in tqdm(dataset.sample_batch(batch_size=1, shuffle=False), desc="Training..."):
