...
machines = [
    dict(ip="freeman-v100-1.csail.mit.edu", gpu_id=3),
    dict(ip="freeman-v100-1.csail.mit.edu", gpu_id=4),
    dict(ip="freeman-v100-1.csail.mit.edu", gpu_id=5),
]
