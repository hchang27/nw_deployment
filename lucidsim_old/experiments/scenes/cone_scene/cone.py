    ...
    async def main(session: VuerSession):
        ...
        while True:
            session.update @ group(
                ...
                Cylinder(args=[0.04, 0.1, 0.25, 20], position=[0, 0.625, 1], key="cone-1", materialType="depth"),
                Cylinder(args=[0.04, 0.1, 0.25, 20], position=[0, 0.625 + 0.45, 0], key="cone-2", materialType="depth"),
                Cylinder(args=[0.04, 0.1, 0.25, 20], position=[0, 0.625 + 0.9, -1], key="cone-3", materialType="depth"),
                Box(args=[3, 0.7, 1], position=[0, 0.15, 1], materialType="depth", key="step-1"),
                Box(args=[3, 0.7, 1], position=[0, 0.6, 0], materialType="depth", key="step-2"),
                Box(args=[3, 0.7, 1], position=[0, 1.1, -1], materialType="depth", key="step-3"),
            ...
            await sleep(0.05)
            res = await session.grab_render(quality=1, downsample=1)
