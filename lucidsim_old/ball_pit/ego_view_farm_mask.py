...
from vuer.schemas import Box, CameraView, DefaultScene, Plane, Scene, Sphere, group
...
class EgoViewRender(PrefixProto):
    ...
    prefix = "scenes"
    dataset_prefix = "ball/debug/scene_00001"

    background_img = None  # "snowy.jpeg"
    plane_texture = None  # "bricks.jpeg"
    ...
    def __post_init__(self, **deps):
        ...
        print(f"RENDER TYPE: {self.render_type}")
    ...
    def _handle_step(self, rollout_id, step, sess):
        ...
        components = [CameraView(**vars(RenderArgs), matrix=mat), Sphere(
            key="ball",
    ...
    async def main(self, sess: VuerSession):
        ...
        if self.render_type != "rgb":
            ...
            components = [Sphere(key="ball", args=[self.ball_radius, 20, 20], **material_kwargs)]
