...
class WebViewer:
    ...
    def _route_index(self) -> 'flask.Response':
        ...
        """
        with open(os.path.join(MAIN_ST_ROOT_DIR, "main_street", "utils", "webviewer.html"), 'r', encoding='utf-8') as file:
            template = file.read()
    ...
    def render(self,
        ...
        self._gym.set_camera_location(self._cameras[self._camera_id], self._envs[self._camera_id], gymapi.Vec3(*cam_pos),
