raise DeprecationWarning("this script is now deprecated.")
import os
import sys
...
from cxx.modules.estimator import Estimator
import argparse
...
class HardwareVisionNN(nn.Module):
    def __init__(self, num_prop,
        ...
        self.actor = Actor(num_prop, num_scan, num_actions, scan_encoder_dims, actor_hidden_dims, priv_encoder_dims, num_priv_latent,
                           num_priv_explicit, num_hist, activation, tanh_encoder_output=tanh)
